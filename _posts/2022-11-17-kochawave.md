...
Whilst browsing twitter the other day this tweet caught my eye about a variation on the famous [Koch curve](https://en.wikipedia.org/wiki/Koch_snowflake) fractal and I thought it would be fun to reproduce it in Python (click [here](/files/Jupyter_notebooks/kochawave.ipynb) to download the Jupyter notebook).
